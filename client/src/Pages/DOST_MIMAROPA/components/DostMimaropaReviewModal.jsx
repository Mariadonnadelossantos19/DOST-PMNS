      ...
      <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-2">
         <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-hidden border border-gray-200">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(95vh-120px)]">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-200 shadow-sm">
                     ...
                     <div className="space-y-3">
                        ...
                        <div>
                           ...
                           <p className="text-sm font-semibold text-gray-900">{selectedApplication.factoryAddress || 'N/A'}</p>
                        </div>
                        <div>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-5 border border-purple-200 shadow-sm">
                     ...
                     <div className="space-y-3">
                        ...
                        <div>
                           ...
                           <p className="text-sm font-semibold text-gray-900">{selectedApplication.employmentClassification || 'N/A'}</p>
                        </div>
                        <div>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-5 border border-indigo-200 shadow-sm">
                     <div className="flex items-center mb-4">
                        ...
                        <div>
                           <h4 className="text-lg font-bold text-gray-900">Business Activity</h4>
                           <p className="text-sm text-indigo-600">Core business operations</p>
                        </div>
                     </div>
                     <div className="space-y-3">
                        <div>
                        ...
                        <div>
                           ...
                           <p className="text-sm font-semibold text-gray-900">{selectedApplication.specificProduct || 'N/A'}</p>
                        </div>
                        <div>
                           ...
                           <p className="text-sm font-semibold text-gray-900 bg-gray-50 p-2 rounded text-xs">
                              {selectedApplication.enterpriseBackground || 'N/A'}
                           </p>
                        </div>
                     </div>
                  </div>
               ...
               <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl p-5 border border-yellow-200 shadow-sm mb-6">
                  <div className="flex items-center mb-4">
                     <div className="w-8 h-8 bg-yellow-500 rounded-lg flex items-center justify-center mr-3">
                        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                     ...
                     <div>
                        ...
                        <p className="text-sm text-yellow-600">Legal agreement and signature details</p>
                     </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div>
                        <p className="text-xs font-medium text-gray-600">Accepted Date</p>
                        <p className="text-sm font-semibold text-gray-900">
                           {selectedApplication.generalAgreement?.acceptedAt ? formatDate(selectedApplication.generalAgreement.acceptedAt) : 'N/A'}
                        </p>
                     </div>
                     <div>
                     ...
                     <div>
                        ...
                        <p className="text-sm font-semibold text-gray-900">{selectedApplication.generalAgreement?.ipAddress || 'N/A'}</p>
                     </div>
                  </div>
               </div>

               {/* Application Timeline */}
               <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-5 border border-gray-200 shadow-sm mb-6">
                  <div className="flex items-center mb-4">
                     ...
                     <div>
                        <h4 className="text-lg font-bold text-gray-900">Application Timeline</h4>
                        <p className="text-sm text-gray-600">Application progress and status history</p>
                     </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div>
                        <p className="text-xs font-medium text-gray-600">Current Stage</p>
                        <Badge className={`px-2 py-1 rounded-full text-xs font-bold ${getStatusColor(selectedApplication.currentStage)}`}>
                           {selectedApplication.currentStage?.replace(/_/g, ' ').toUpperCase() || 'N/A'}
                        </Badge>
                     </div>
                     <div>
                        <p className="text-xs font-medium text-gray-600">Overall Status</p>
                        <Badge className={`px-2 py-1 rounded-full text-xs font-bold ${getStatusColor(selectedApplication.status)}`}>
                           {selectedApplication.status?.replace(/_/g, ' ').toUpperCase() || 'N/A'}
                        </Badge>
                     </div>
                     <div>
                     ...
                     <div>
                        ...
                        <p className="text-sm font-semibold text-gray-900">
                           {selectedApplication.updatedAt ? formatDate(selectedApplication.updatedAt) : 'N/A'}
                        </p>
                     </div>
                     <div>
                        <p className="text-xs font-medium text-gray-600">PSTO Reviewed Date</p>
                        <p className="text-sm font-semibold text-gray-900">
                           {selectedApplication.pstoReviewedAt ? formatDate(selectedApplication.pstoReviewedAt) : 'N/A'}
                        </p>
                     </div>
                     <div>
                        <p className="text-xs font-medium text-gray-600">DOST MIMAROPA Status</p>
                        <Badge className={`px-2 py-1 rounded-full text-xs font-bold ${getStatusColor(selectedApplication.dostMimaropaStatus)}`}>
                           {selectedApplication.dostMimaropaStatus?.replace(/_/g, ' ').toUpperCase() || 'PENDING'}
                        </Badge>
                     </div>
                  </div>
               </div>
                        ...
                        {selectedApplication.letterOfIntent?.filename && (
                           <div className="space-y-2">
                              <div className="text-xs text-gray-600">
                                 ...
                                 <p><span className="font-medium">Type:</span> {selectedApplication.letterOfIntent.mimetype}</p>
                              </div>
                              <button
                        ...
                        {selectedApplication.enterpriseProfile?.filename && (
                           <div className="space-y-2">
                              <div className="text-xs text-gray-600">
                                 ...
                                 <p><span className="font-medium">Type:</span> {selectedApplication.enterpriseProfile.mimetype}</p>
                              </div>
                              <button
                        ...
                        {selectedApplication.businessPlan?.filename && (
                           <div className="space-y-2">
                              <div className="text-xs text-gray-600">
                                 ...
                                 <p><span className="font-medium">Type:</span> {selectedApplication.businessPlan.mimetype}</p>
                              </div>
                              <button
