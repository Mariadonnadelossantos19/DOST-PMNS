...
const PalawanDashboard = ({ currentUser }) => {
   ...
   const fetchProponents = async () => {
      try {
         ...
         const response = await fetch(`http://localhost:4000/api/users/psto/Palawan/proponents`, {
            headers: {
   ...
   const renderProponents = () => (
      <div className="space-y-6">
         <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-gray-900">Palawan Proponents</h2>
            <div className="flex space-x-2">
         ...
         {loading ? (
            ...
            <div className="text-center py-8">
               ...
               <p className="text-gray-500">Proponents from Palawan will appear here once they register.</p>
            </div>
         ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
