               ...
               {availableDocuments.some(doc => doc.documentStatus === 'submitted' && doc.reason) && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                     ...
                     <p className="text-xs text-green-700 mb-3">
                        <strong>Note:</strong> These documents are for applications that were "Endorsed for Approval (with Comment)". 
                        Once approved, the application will proceed directly to "Ready for Funding" without scheduling another meeting.
                     </p>
               ...
               {rtecEvaluationData.evaluationOutcome === 'endorsed for approval (with comment)' && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                     ...
                     <p className="text-sm text-blue-700 mb-3">
                        For "Endorsed for Approval (with Comment)" outcome, the proponent will need to submit a "Response to RTEC Comments" 
                        document to address the specific comments. Once approved, the application will proceed directly to "Ready for Funding" 
                        <strong> without scheduling another meeting</strong>.
                     </p>
                     <div className="text-xs text-blue-600">
                        <strong>Workflow:</strong> Proponent submits response → DOST-MIMAROPA reviews → If approved, application moves to "Ready for Funding" status automatically.
                     </div>
                  </div>
               )}
