         ...
         <div className="bg-white rounded-2xl shadow-2xl max-w-7xl w-full max-h-[98vh] overflow-hidden border border-gray-200">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(98vh-120px)]">
               ...
               <div className="space-y-4 mb-6">
                  ...
                  {/* Application Status, Processing & Timeline */}
                  <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-3 border border-red-200 shadow-sm">
                     <div className="flex items-center mb-3">
                        ...
                        <div>
                           <h4 className="text-base font-bold text-gray-900">Application Status, Processing & Timeline</h4>
                           <p className="text-xs text-red-600">Current status, workflow progress, and important dates</p>
                        </div>
                     </div>
                     ...
                     <div className="mb-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                           <div className="bg-white rounded-lg p-2 border border-red-100">
                              ...
                              <Badge className={`px-1.5 py-0.5 rounded-full text-xs font-bold ${getStatusColor(selectedApplication.status)} mt-0.5`}>
                                 {selectedApplication.status?.toUpperCase() || 'N/A'}
                              </Badge>
                           </div>
                           <div className="bg-white rounded-lg p-2 border border-red-100">
                              <p className="text-xs font-medium text-gray-600">PSTO Status</p>
                              <Badge className={`px-1.5 py-0.5 rounded-full text-xs font-bold ${getStatusColor(selectedApplication.pstoStatus)} mt-0.5`}>
                                 {selectedApplication.pstoStatus?.toUpperCase() || 'PENDING'}
                              </Badge>
                           </div>
                           <div className="bg-white rounded-lg p-2 border border-red-100">
                              <p className="text-xs font-medium text-gray-600">Current Stage</p>
                              <p className="text-xs font-semibold text-gray-900 mt-0.5">{selectedApplication.currentStage || 'Initial Review'}</p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                           <div className="bg-white rounded-lg p-2 border border-red-100">
                              ...
                              <p className="text-xs font-semibold text-gray-900 mt-0.5">{formatDate(selectedApplication.createdAt)}</p>
                           </div>
                           <div className="bg-white rounded-lg p-2 border border-red-100">
                              <p className="text-xs font-medium text-gray-600">Last Updated</p>
                              <p className="text-xs font-semibold text-gray-900 mt-0.5">{formatDate(selectedApplication.updatedAt)}</p>
                           </div>
                           {selectedApplication.forwardedAt && (
                              <div className="bg-white rounded-lg p-2 border border-red-100">
                                 <p className="text-xs font-medium text-gray-600">Forwarded Date</p>
                                 <p className="text-xs font-semibold text-gray-900 mt-0.5">{formatDate(selectedApplication.forwardedAt)}</p>
                              </div>
                           )}
                           {selectedApplication.expectedStartDate && (
                              <div className="bg-white rounded-lg p-2 border border-red-100">
                                 <p className="text-xs font-medium text-gray-600">Expected Start Date</p>
                                 <p className="text-xs font-semibold text-gray-900 mt-0.5">{formatDate(selectedApplication.expectedStartDate)}</p>
                              </div>
                           )}
                           {selectedApplication.expectedEndDate && (
                              <div className="bg-white rounded-lg p-2 border border-red-100">
                                 <p className="text-xs font-medium text-gray-600">Expected End Date</p>
                                 <p className="text-xs font-semibold text-gray-900 mt-0.5">{formatDate(selectedApplication.expectedEndDate)}</p>
                              </div>
                           )}
                        </div>
                     </div>
