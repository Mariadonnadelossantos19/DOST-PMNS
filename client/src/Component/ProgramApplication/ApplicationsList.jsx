               ...
               <div className="flex justify-end space-x-2 pt-2 border-t border-gray-100">
                  ...
                  {application.pstoStatus === 'approved' && !application.forwardedToDostMimaropa && (
                     <button
                        ...
                        className="p-2 bg-green-100 hover:bg-green-200 text-green-600 rounded-lg transition-colors duration-200 flex items-center justify-center group disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <button
                     ...
                     disabled={isDeleting}
                     className="p-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg transition-colors duration-200 flex items-center justify-center group disabled:opacity-50 disabled:cursor-not-allowed"
